...
for sigma_train in [0.04,0.06,0.07]:
    noise_scale = np.sqrt(0.5)*sigma_train* 255
    ...
    for alpha_train in train_list:
        ...
        for repeat_time in range(1):
            ...
            model.save('./singletest/resnet_trainalpha{}_trainsigma{}_repeattimes{}_numfilters{}_numblocks{}.h5'.format(alpha_train,sigma_train, repeat_time,num_filter_block,num_res))
