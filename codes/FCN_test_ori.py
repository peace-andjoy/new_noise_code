...
if depth != 3:
    ...
    lr = 0.001
    iters = 10000
respath = "../results20231202/acc_FCN_width{}_depth{}_b{}_alphatrain{}_sigmatrain{}_lr{}_iter{}_alphatest{}_sigmatest{}_ori.txt".format(width,depth,b,alpha_train,sigma_train,lr,iters,alpha_test,sigma_test)
